...
_CATALOG = {
    ...
    "Imagen adaptada al 100% del ancho y alto de la ventana": "Image stretched to 100% of the window width and height",
    "Alto max": "Max height",
    "Skew X": "Skew X",
    "Skew Y": "Skew Y",
    "Pinch X": "Pinch X",
    "Pinch Y": "Pinch Y",
    "Rotacion": "Rotation",
    "AJUSTE A TV (perspectiva)": "TV FIT (perspective)",
    "Desplaza cada esquina del snap sobre la pantalla del TV.\nUtil cuando el televisor no esta de frente (imagen en perspectiva).":
        "Move each snap corner over the TV screen.\nUseful when the TV is not facing the camera (image in perspective).",
    "Sup-izq X": "Top-left X",
    "Sup-izq Y": "Top-left Y",
    "Sup-der X": "Top-right X",
    "Sup-der Y": "Top-right Y",
    "Inf-izq X": "Bottom-left X",
    "Inf-izq Y": "Bottom-left Y",
    "Inf-der X": "Bottom-right X",
    "Inf-der Y": "Bottom-right Y",
    ...
    "SCRAPER": "SCRAPER",
    "Obtiene la informacion de los juegos de una plataforma (anio, genero, fabricante). Los resultados se guardan en el cache.":
        "Gets the info of the games of a platform (year, genre, manufacturer). Results are saved to the cache.",
    "Selecciona la plataforma a scrapear": "Select the platform to scrape",
    "Scrapear juegos": "Scrape games",
    "Lanza el scraping de todos los juegos de la plataforma seleccionada":
        "Starts scraping all games of the selected platform",
    "Detener": "Stop",
    "Listo": "Ready",
    "Sin juegos para scrapear": "No games to scrape",
    "Scrapeando: {rom}...": "Scraping: {rom}...",
    "Scrapeando: {rom} ({a}/{t})": "Scraping: {rom} ({a}/{t})",
    "{o} de {t} juegos con info": "{o} out of {t} games with info",
    "Scrapeando {n} juegos...": "Scraping {n} games...",
    "Deteniendo...": "Stopping...",
    "API key RAWG": "RAWG API key",
    ...
    "Carpeta wheels": "Wheels folder",
    "Carpeta snaps / videos": "Snaps / videos folder",
    "Carpeta marquee": "Marquee folder",
